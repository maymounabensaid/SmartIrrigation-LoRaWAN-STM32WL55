...
- [STM32WL55](endnode-stm32wl55jc.md): STM32 LoRa Board active and fully supported by STMicroelectronics. [https://www.st.com/en/microcontrollers-microprocessors/stm32wl55jc.html
   ...
   - Sensors: 
     ...
     - [DFRobot-SEN0308](sen0308.md): measures soil _moisture_ (volumetric water content as a percentage) 
     - [DS18B20](ds18b20.md): measures soil temperature
     - [BME680](bme680.md): measures air temperature, relative humidity and barometric pressure
     - [SI1145](si1145.md): measures visible & NIR (Near Infra-Red) light and estimates a UV index using a mathematical approximation from visible and IR readings 
...
- [Dragino-LPS8](gateway-dragino-lps8.md): An open source LoRaWAN Gateway. [https://www.dragino.com/products/lora-lorawan-gateway/item/148-lps8.html
